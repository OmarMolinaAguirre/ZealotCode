...
@Autonomous(name="Test Time Reset After Loop", group="Zealot")
@Disabled
public class Test_TimeResetAfterLoop extends LinearOpMode {
...
// Test Methods
    ...
    public void DriveForward(double secs) {
        ...
        robot.rightMotorF.setPower(FORWARD_SPEED);
        while (opModeIsActive() && (runtime.seconds() < secs)) {
            telemetry.addData("Drive Forward: Elapsed", runtime.seconds());
            telemetry.update();
        }
        runtime.reset();
    }
